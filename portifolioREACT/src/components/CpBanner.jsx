            ...
            <div className="wrap column-1">
                <div className="title-banner">
                    <h1 className="text-banner">
                        <p className="nome">Taina Bragante!</p>
                        <p className="funcao">Desenvolvedora Web FullStack</p>
                        <p className="descricao">Este é meu portifolio, conheça um pouco mais sobre o meu trabalho!</p>
                    </h1>

                    <div className="btn-portifolio">
                        <a href="https://github.com/tainabragante" target="_blank" className="link-github">
                            <img src={github_banner} alt="GitHub!" title="GitHub!" className="github"/>
                                GitHub
                        </a>
                        <a href="https://www.linkedin.com/in/taina-costa-bragante/" target="_blank" className="link-linkedin">
